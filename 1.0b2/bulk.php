...
echo <<<EOF
<form action="submitbulk.php" method="post">
<p>please remember to remove timestamps and unrelated chatter. keep quotes to 80 characters wide (the width of this box).</p>
<p>bulk upload procedure: separate quotes with a blank line.</p>
<textarea name="quote" rows="30" cols="80"></textarea></p>
<p><i>Did you separate your quotes with blank lines?</i></p>
<p><i>Did you remove timestamps?</i></p>
<p><i>Did you keep your quotes to 80 characters wide?</i></p>
<p><input type="submit" value="Add lots of quotes"></p>
EOF;
